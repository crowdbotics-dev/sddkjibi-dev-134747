"""
Django settings for sddkjibi_dev_134747 project.
...
ROOT_URLCONF = 'sddkjibi_dev_134747.urls'
...
WSGI_APPLICATION = 'sddkjibi_dev_134747.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "sddkjibi_dev_134747 API",
    "DESCRIPTION": "API documentation for sddkjibi_dev_134747 App",
    "VERSION": "v1",
}
